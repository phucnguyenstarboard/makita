...
class Simple_Job_Board_Resume_Download_Handler {
    ...
    public function download_resume() {
        ...
        if (isset($_GET['resume_id'])) {
            $resume = get_post_meta(intval( $_GET['resume_id'] ), 'resume_path', TRUE);
        ...
        if (in_array($file_extension, $allowed_file_exts)) {
            ...
            wp_die(__('You are not allowed to download this file.', 'simple-job-board'), '', array('response' => 404));
        }
