        ...
        $('#settings_addFeature').on("click", function () {
            ...
            if (fieldName != '') {
                ...
                if(fieldIcon != undefined && fieldIcon != '' ){
                    ...
                    <input type="text" class="sjb-job-feature-icon iconpicker-element iconpicker-input" name="jobfeature_' + fieldName + '[icon]" placeholder="fa ' + fieldIcon + '" value="' + fieldIcon + '" /><span class="input-group-addon"><i class="fa ' + fieldIcon + '"></i></span>\n\
            ...
            if (app_field_name != '') {
                ...
                $('#settings_app_form_fields').append('<li class="jobapp_' + app_field_name + '">\n\
                    ...
                    <div class="col-lg-5 col-md-5">\n\
                        <label>\n\
                            <span class="sjb-form-group"><input type="checkbox" class="settings-jobapp-required-field"  ' + isRequired + '>\n\
                            <input type="hidden"   name="jobapp_' + app_field_name + '[optional]"  value="' + isRequired + '"></span>' + application_form.settings_jquery_alerts['required'] + '&nbsp;\n\
                        </label>\n\
