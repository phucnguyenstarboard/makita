                            ...
                            foreach ($fields as $field => $val) {
                                if ('jobfeature_' == substr($field, 0, 11)) {
                                    ...
                                    if ($job_post_layout_version == 'v2') {
                                        ...
                                        echo '<input type="text" id="icon_' . $field . '" class="sjb-job-feature-icon" name="' . $field . '[icon]" value="' . $icon_value . '" /><span class="input-group-addon"><i class="fa ' . $icon_value . '"></i></span> ';
                                    }
